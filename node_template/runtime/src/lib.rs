...
// pub use pallet_assetdiscovery;
pub use pallet_assets;
pub use pallet_proposal;
pub use pallet_rootdns;
...
pub const ASSET_DEPOSIT: Balance = 100;
pub const APPROVAL_DEPOSIT: Balance = 1;
pub const STRING_LIMIT: u32 = 50;
pub const METADATA_DEPOSIT_BASE: Balance = 10;
pub const METADATA_DEPOSIT_PER_BYTE: Balance = 1;
pub const REMOVE_ITEMS_LIMIT: u32 = 50;
...
impl pallet_tld::Config for Runtime {
	...
	type AuthorityId = pallet_tld::crypto::TestAuthId;
}
...
parameter_types! {
	pub const AssetDeposit: Balance = ASSET_DEPOSIT;
	pub const ApprovalDeposit: Balance = APPROVAL_DEPOSIT;
	pub const StringLimit: u32 = STRING_LIMIT;
	pub const MetadataDepositBase: Balance = METADATA_DEPOSIT_BASE;
	pub const MetadataDepositPerByte: Balance = METADATA_DEPOSIT_PER_BYTE;
...
mod runtime {
	...
	pub type ProposalModule = pallet_proposal;

	#[runtime::pallet_index(11)]
	pub type AssetsModule = pallet_assets;
...
mod benches {
	frame_benchmarking::define_benchmarks!(
		...
		[pallet_proposal, ProposalModule]
